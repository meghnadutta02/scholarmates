    ...
    <>
      <Link href="/requests">
        <div
          ...
          class="w-full max-w-xs p-4 text-gray-900 bg-white rounded-lg shadow dark:bg-gray-800 dark:text-gray-300 md:w-[85%] "
          role="alert"
        >
          ...
          <div class="flex items-center">
            <div class="ms-3 text-sm font-normal">
              ...
              <div class="text-sm font-normal">sent a connection request</div>
